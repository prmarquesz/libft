...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/05/21 22:39:47 by proberto          #+#    #+#              #
#    Updated: 2021/05/21 22:39:47 by proberto         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

# SRC = $(wildcard ./ft*.c)
SRC = ft_strlen.c ft_strlcpy.c ft_strlcat.c ft_isalpha.c ft_isdigit.c		   \
ft_isalnum.c ft_isascii.c ft_isprint.c ft_toupper.c ft_tolower.c ft_strchr.c   \
ft_strrchr.c ft_strnstr.c ft_strncmp.c ft_atoi.c ft_memset.c ft_bzero.c		   \
